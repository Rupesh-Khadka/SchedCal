  ...
  return (
    <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <div className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium">
          <svg
          ...
          <span className="relative z-10">
            Wow SchedCal is the best platform I have ever used. Definitley
            recomment it to you guys, try it out!
          </span>
        </div>

        <footer className="mt-6">
          <p className="font-semibold">Rupesh Khadka</p>
