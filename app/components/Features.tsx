    ...
    <div className="py-24">
      <div className="max-w-2xl mx-auto lg:text-center">
        ...
        <p className="mt-6 text-base leading-snug text-muted-foreground">
          With SchedCal you can schedule meetings in minutes. We make it easy
          ...
          {features.map((feature) => (
            <div key={feature.name} className="relative pl-16">
              <div className="text-base font-medium leading-7">
                <div className="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-blue-600/85">
